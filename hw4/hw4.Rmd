...
par(mfrow = c(1, 2))
pie(seq1_prop, labels = paste(names(seq1_prop), "=", round(seq1_prop * 100, 3), "%", sep = ""), col = colors1, main = ac_1)
pie(seq2_prop, labels = paste(names(seq2_prop), "=", round(seq2_prop * 100, 3), "%", sep = ""), col = colors2, main = ac_2)
```
